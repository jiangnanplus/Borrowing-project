...
<body>
    ...
    <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i>管理员组列表</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                            <form action="<?php echo U('Admin/AdminAuth/index_group');?>" method="get">
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th style="width: 180px;">管理员组名称</th>
                                    <th style="width: 600px;">拥有规则ID</th>
                                    ...
                                    <td style="padding:2px;">
                                        <!-- <div class="mws-form-row"> -->
                                            ...
                                            <div class="mws-form-item"> -->
                                                <textarea class="required large small" style="width:626px;height:26px;resize:vertical;"><?php echo ($vo['rules']); ?></textarea>
                                            <!-- </div> -->
                                        <!-- </div> -->
                                    </td>
                                    <td align="center"><?php echo ($vo['status'] ? "启用" : "禁用"); ?></td>
                                    <?php if(($vo['uid']) == "1"): ?><td class=" " align="center"><a class="btn btn-small" href="<?php echo U('Admin/AdminAuth/edit_group_access', array('id'=>$vo['uid']));?>"><i class="icon-pencil"></i></a> <a class="btn btn-small"><i class="icon-trash"></i></a></td>
                                    <?php else: ?>
