                        ...
                        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th style="width: 112px;">邮箱</th>
                                    <th style="width: 80px;">小米账号</th>
                            ...
                            <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo['ssid']); ?></td>
                                    <td align="center"><?php echo ($vo['name']); ?></td>
                                    <!-- <td align="center"><?php echo ($vo['sex'] ? '男' : '女'); ?></td> -->
                                    <td align="center"><?php echo date('Y-m-d H:i:s',$vo['rtime']);?></td>
                                    <td align="center"><?php echo long2ip($vo['rip']);?></td>
                                    <td align="center"><?php echo ($vo['status'] ? "启用" : "禁用"); ?></td>
                                    
                                    <td class=" " align="center"><a class="btn btn-small" href="<?php echo U('Admin/User/edit', array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a> <a class="btn btn-small" href="<?php echo U('Admin/User/delete', array('id'=>$vo['id']));?>"><i class="icon-trash"></i></a></td>
