            	...
            	<table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
	                <thead>
	                    <tr role="row">
	                    	...
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 199px;" aria-label="Browser: activate to sort column ascending">标题
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">主图
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">分类
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">价格
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">折扣
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">颜色
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">尺码
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">库存
	                    	</th>
		            ...
		            <tbody role="alert" aria-live="polite" aria-relevant="all"  style="text-align:center;width:100%">
		            	<?php if(is_array($infos)): foreach($infos as $key=>$vo): ?><tr class="odd">
		                        <td class="  sorting_1"><?php echo ($vo['gid']); ?></td>
		                        <td class=" "><?php echo ($vo['title']); ?></td>
		                        <td class=" "><img style="width:30px;height:30px" src="/322_thinkphp_xiaomi/Public/Upload/Goods/<?php echo ($vo['s_img'][0][0]); ?>"></td>
		                        <td class=" " style="text-align:left"><?php echo ($path[$key]); ?></td>
		                        <td class=" "><?php echo ($vo['price']); ?></td>
		                        <td class=" "><?php echo ($vo['discount']); ?></td>
		                        <td class=" "><?php echo ($vo['colortit']); ?></td>
		                        <td class=" "><?php if($vo['mcid'] == 31): echo ($vo['size']); else: ?>无<?php endif; ?></td>
		                        <td class=" "><?php echo ($vo['num']); ?></td>
		                        <td class=" ">
                                    <span class="btn-group">
                                        <a class="btn btn-small" href="<?php echo U('Admin/Goods/edit',array('gid'=>$vo['gid']));?>"><i class="icon-pencil"></i></a>
                                        <a class="btn btn-small condelete" href="<?php echo U('Admin/Goods/delete',array('gid'=>$vo['gid']));?>"><i class="icon-trash"></i></a>
                                    </span>
                                </td>
