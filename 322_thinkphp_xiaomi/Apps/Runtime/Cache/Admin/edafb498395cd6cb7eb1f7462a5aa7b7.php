...
<body>
	...
	<div class="mws-panel grid_8">
        ...
        <form action="<?php echo U('Admin/Goodsclass/index');?>" method="get">
            	...
            	<table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
	                <thead>
	                    <tr role="row">
	                    	...
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 199px;" aria-label="Browser: activate to sort column ascending">分类名称
	                    	</th>
	                    	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 184px;" aria-label="Platform(s): activate to sort column ascending">所属父类
	                    	</th>
		            ...
		            <tbody role="alert" aria-live="polite" aria-relevant="all">
		            	<?php if(is_array($goodsclasses)): foreach($goodsclasses as $key=>$vo): ?><tr class="odd">
		                        <td class="  sorting_1"><?php echo ($vo['cid']); ?></td>
		                        <td class=" "><?php echo ($vo['name']); ?></td>
		                        <td class=" "><?php echo ($vo['paid']); ?></td>
		                        <td class=" " style="text-align:center">
                                    <span class="btn-group">
                                        <a class="btn btn-small" href="<?php echo U('Admin/Goodsclass/edit',array('cid'=>$vo['cid']));?>"><i class="icon-pencil"></i></a>
                                        <a class="btn btn-small classdelete" href="<?php echo U('Admin/Goodsclass/delete',array('cid'=>$vo['cid']));?>"><i class="icon-trash"></i></a>
                                    </span>
                                </td>
